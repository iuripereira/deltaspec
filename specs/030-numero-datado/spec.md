...
## Contexto (≤3 linhas)
Cenário do TRUTH pode citar número que era verdadeiro no dia da medição e deixa de ser depois, sem que nada acuse ([DT-029](../../DEBT.md)): o R13 diz "acusaria 19 links vivos do `DEBT.md`" e hoje são 23.
...
## Fora de escopo
- **Check que recalcula o número** — renúncia por decisão do usuário (2026-08-04): cada medição é um comando ad-hoc de época; o check exigiria versionar a receita junto de cada número, mecanismo caro para as 4 ocorrências vivas (todas no R13). Se a disciplina de escrita falhar repetidamente, o DT reabre com essa opção.
