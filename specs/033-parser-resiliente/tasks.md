...
- [ ] T4 — C1 acusa heading `###` fora da forma canônica em vez de perder o requisito em silêncio · arquivos: skills/spec-feature/scripts/check_cycle.py · cobre: R1 · verificação: python3 skills/spec-feature/scripts/check_cycle.py --selftest + 0 achado novo nas 33 deltas arquivadas
