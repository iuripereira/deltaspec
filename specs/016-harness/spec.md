# delta-016 — harness
Estado: proposta · Data: 2026-07-28 · Branch: feat/016-harness · Perfil: completo — mexe no contrato do ciclo (template de tasks, gate, adapters) e adota motor novo; risco estrutural
...
- [ ] Aberto (clarify): forma final da trilha de auditoria (R5 — linhas nos artefatos da própria fase vs arquivo de auditoria separado, padrão AI-DLC)
- [ ] Aberto (clarify): adotar check de convergência tipo `/converge` no archive (mecanizável mínimo vs renúncia registrada)
- [ ] Aberto (clarify): alcance do "dashboard de impacto de PR" do graphify no review
