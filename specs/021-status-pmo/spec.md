...
Estado: proposta · Data: 2026-07-31 · Branch: feat/021-status-pmo · Perfil: enxuto — skill nova aditiva, sem mudança em skill existente nem em gate; clarify já feito no repo cliente (aprovado: 2026-07-31, plano aprovado em plan mode no repo imex)
...
### R2 — ADICIONA: templates da skill
