...
- [x] CT3 — arquivo sem seção lançada é varrido inteiro · cobre: R1 · tipo: auto · verificação: fixture de markdown comum com link morto no fim → 1 achado, como antes da delta
