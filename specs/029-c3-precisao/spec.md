...
- **O recorte por conteúdo cega qualquer arquivo abaixo do primeiro `## [X.Y.Z]`,** inclusive se alguém puser conteúdo vivo lá por engano. É o mesmo tipo de cegueira que a delta-027 registrou para `--code-only` do graphify: aceita por ser o que a convenção do Keep a Changelog garante, e declarada aqui.
