...
[Current version: tags](https://github.com/iuripereira/deltaspec/tags) · 17 skills · MIT License
...
Done: the 17 skills show up under the `deltaspec:` prefix. To update later, `/plugin update deltaspec@deltaspec` — without the marketplace's `@deltaspec`, the plugin is not found.
...
The seventeenth is not a command: [`eu-tenho-tdah`](skills/eu-tenho-tdah/SKILL.md) is Iuri's writing profile (based on [ayghri/i-have-adhd](https://github.com/ayghri/i-have-adhd)), always on — action before context, ranked lists, tangents become saved pending items.
