...
**2 — Só Mermaid, sem camada Figma.** Mantém o status quo; renuncia ao acabamento de apresentação que stakeholder de contrato espera (validado nos projetos do caso de referência).
