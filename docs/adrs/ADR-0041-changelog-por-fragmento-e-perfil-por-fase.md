...
- **Data:** 2026-08-31
- **Supersedes:** —
- **Superseded by:** [ADR-0045](ADR-0045-release-por-skills-do-plugin-e-merge-commit-na-main.md) (2026-09-10, delta-117) — **em duas cláusulas**: "release-please só para versão e tag" (a tag passa a nascer na skill `/deltaspec:release` e o release-please sai de todos os perfis) e "o perfil do repositório é a FASE" (o perfil do `projeto-infra` passa a ser a topologia de branch). Fragmento por PR, um dono só do CHANGELOG e a fase lida do repo — agora só como sinal do C18 — seguem vigentes.
