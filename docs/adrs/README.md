...
| [0045](ADR-0045-release-por-skills-do-plugin-e-merge-commit-na-main.md) | Release por skills do plugin — branch dedicada, merge commit na `main` e a tag nasce na sessão | Accepted | 2026-09-10 |
