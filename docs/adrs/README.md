...
| [0040](ADR-0040-pre-commit-com-dono-unico.md) | O `pre-commit` distribuído tem dono único — a `git-guard` | Accepted | 2026-08-27 |
| [0041](ADR-0041-changelog-por-fragmento-e-perfil-por-fase.md) | A entrada de CHANGELOG nasce como fragmento por PR, e o perfil do repo é a fase | Superseded by 0045 (cláusulas do release-please e do perfil por fase) | 2026-08-31 |
| [0039](ADR-0039-recusa-de-scanner-de-segredo-externo.md) | Detecção de segredo fica em stdlib, com o buraco de cobertura declarado no catálogo | Accepted | 2026-08-22 |
| [0042](ADR-0042-licoes-em-arquivo-por-item.md) | Lições em arquivo por item, com índice gerado e cadastro por comando | Accepted | 2026-09-04 |
| [0043](ADR-0043-ordem-de-integracao-derivada.md) | Ordem de integração derivada, vista regenerada, sem arquivo nem hook | Accepted | 2026-09-07 |
| [0044](ADR-0044-replanejamento-como-documento-novo.md) | Replanejamento é documento novo com fatos rastreados, não edição do plano vigente | Accepted | 2026-09-05 |
| [0045](ADR-0045-release-por-skills-do-plugin-e-merge-commit-na-main.md) | Release por skills do plugin — branch dedicada, merge commit na `main` e a tag nasce na sessão | Superseded by 0048 (só o deltaspec como perfil sem `develop`) | 2026-09-10 |
| [0047](ADR-0047-registro-de-captura-e-repo-com-debts.md) | O registro de captura é um repositório com `debts/`, não um ledger de linha | Accepted | 2026-09-10 |
| [0048](ADR-0048-deltaspec-no-perfil-com-develop.md) | O deltaspec passa ao perfil com `develop` | Superseded by 0049 (só a cláusula do `Closes #N` na release) | 2026-09-13 |
| [0049](ADR-0049-issue-fecha-no-merge-e-a-release-carimba.md) | A issue fecha no merge da PR na `develop`, e a release carimba a versão | Accepted | 2026-09-22 |
