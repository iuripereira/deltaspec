...
- **Superseded by:** [ADR-0049](ADR-0049-issue-fecha-no-merge-e-a-release-carimba.md) (2026-09-22) — **em uma cláusula**: "`Closes #N` só fecha a issue quando o commit chega à `main`, na release" (Consequences). Com o `fechar-issues-no-merge`, a issue fecha no merge na `develop` e a release carimba a versão; o resto do perfil com `develop` segue vigente.
