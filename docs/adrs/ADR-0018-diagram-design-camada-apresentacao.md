...
- **Superseded by:** [ADR-0029](ADR-0029-apresentacao-como-modo-e-html-autocontido-canonico.md)
...
**2 — Só render CLI, sem camada de apresentação.** É a alternativa 2 já renunciada na ADR-0015: o gap de acabamento para cliente/gestão/stakeholder é real (validado nos projetos do caso de referência).
