...
- **Data:** 2026-07-19
- **Supersedes:** —
- **Superseded by:** [ADR-0021](ADR-0021-projecao-de-tickets.md) (2026-08-01, delta-023) — **apenas na parte das Issues**: a alternativa 3 (espelho sancionado) foi adotada quando a cláusula "Reabre quando" abaixo disparou. Depois, [ADR-0030](ADR-0030-registro-de-debitos-em-pasta-na-raiz.md) (2026-08-11, delta-043) — **apenas na leitura de trajetória** (`git log DEBT.md`/`grep -c`): o registro vira a pasta `debts/` e a trajetória passa a ser por arquivo. O file-first, os IDs `DT-NNN` e a regra "quitado muda de status, nunca some" seguem vigentes e continuam sendo referenciados por esta ADR.
