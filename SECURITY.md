...
- **Melhor esforço, sem prazo garantido** — o projeto é mantido por uma pessoa. Todo reporte recebe confirmação e triagem. Aceito → correção na última versão e advisory publicado com crédito a quem reportou (salvo pedido de anonimato). Recusado → a justificativa fica registrada no próprio advisory.
- O canal preferencial é o reporte privado do GitHub acima. Sem resposta em tempo razoável, escreva para <iuripereira@gmail.com> com `[SECURITY]` no assunto.
