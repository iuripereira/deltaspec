...
A skill acumula três papéis — diário de sessão, registro de débito/lição, projeção de ticket — em quatro scripts que nenhum outro texto da skill nomeava até esta lista (DT-116; fatiar a skill é caro e fica para além desta delta, mas quem move um destes arquivos precisa saber quem depende dele):
