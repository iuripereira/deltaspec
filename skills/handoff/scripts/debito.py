...
def main() -> None:
    ...
    p.add_argument("comando", choices=("fila", "exportar", "diff", "migrar", "indice"))
...
def selftest_git() -> None:
    ...
    print(f"selftest git: OK (churn real, Pr derivada, stale >{STALE_DIAS}d nos dois layouts, degradação sem git)")
