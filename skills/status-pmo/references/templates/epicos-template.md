...
| ID | Tarefa | Dep | Status | Esperado |
|---|---|---|---|---|
| E1-T1 | {{tarefa — cite o RF quando existir: "RF-01 — …"}} | — | prevista | |
| E1-T2 | {{tarefa sem RF}} | E1-T1 | prevista | {{o que fica pronto e como se confere}} |
...
<!-- Regras:
     ...
     · `Esperado` é opcional e só para tarefa que NÃO cita requisito — com `RF-NN`/`RNF-NN`
       no nome, o esperado é o texto do requisito, extraído do PRD (onepage-layout.md
       § Página da entrega); tabela de 4 colunas, sem `Esperado`, segue válida. -->
