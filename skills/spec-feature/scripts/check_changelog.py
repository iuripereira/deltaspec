...
def checar(texto: str, sem_pr: bool = False):
    ...
    for v, n in sorted(versoes.items(), reverse=True):
...
"""
    ...
    print(f"selftest: OK (C1 categoria · C2 tamanho e hard-wrap · C3 referência e --sem-pr · "
          f"C4 topo e ordem · C5 rodapé nos dois sentidos · cerca ignorada · limite {LIMITE_CHARS})")
