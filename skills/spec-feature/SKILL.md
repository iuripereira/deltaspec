...
- `scripts/check_changelog.py` — gate do formato da entrada de CHANGELOG (C1 categoria PT-BR · C2 tamanho do bullet · C3 referência de PR · C4 ordenação das seções · C5 correspondência heading ↔ rodapé), rodado no passo 8 do archive. `--sem-pr` para repo cujo fluxo não passa por PR; `--selftest` valida o próprio script.
