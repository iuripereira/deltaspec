...
| review | implementação completa | eixo Spec (conformidade) ok; eixo Qualidade ok com delete-list do /ponytail-review tratada; achados convergentes dos dois eixos tratados — eixos em subagentes paralelos quando o harness suporta, senão inline (contrato: adapters.md, "Review em dois eixos") | superpowers + ponytail:ponytail-review |
