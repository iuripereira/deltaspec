...
| `debts/` · site-estatico e tooling | `debts/README.md` do template `debts-README.md` + pasta `ativos/` | nada (⚠️ = criar só no 1º débito/pendência é aceitável se o usuário preferir; `_archive/` e `LICOES.md` nascem no primeiro uso) |
