...
| docs-sdd · site-estatico | ADRs, HANDOFF.md, debts/ | specs/épicos, IDs RN/RNF/DEP/EPIC, regra de propagação |
| docs-sdd · tooling | ADRs, IDs estáveis, HANDOFF.md, debts/, doc em camadas | specs/épicos estáticos (o ciclo sdd cobre), regra de propagação (sem DATA_DICTIONARY) |
