---
name: projeto-init
description: Use when initializing or standardizing a repository and a CLAUDE.md plus documentation scaffold is needed — CHANGELOG, STATE, debts, ADRs, specs, glossary. Triggers include "/deltaspec:projeto-init", "init personalizado", "gerar CLAUDE.md canônico", "scaffold de documentação", or setting up Keep a Changelog / SemVer / Conventional Commits / SDD conventions in a project.
---
...
8. **Verificar e reportar**: liste o que criou e o que pulou, com o porquê (ex.: "pulei a tríade de release: workspace de dados não versiona releases").
...
- `references/templates/` — CHANGELOG, HANDOFF (índice), handoff-sessao, debts-README, ADR-TEMPLATE, SPEC-TEMPLATE, GLOSSARY, DATA_DICTIONARY, doc-profile.yaml, gitignore-secrets.
