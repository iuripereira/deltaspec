...
| Ambiente | Destino |
|---|---|
| Repo com `debts/` | `debito.py novo` grava em `debts/ativos/` já validado — ele calcula o `DT-NNN` e escreve o formato; a gramática dos campos é do `debts/README.md` daquele repo |
