...
| Fora de repo | mecânica em [references/destinos-fora-de-repo.md](references/destinos-fora-de-repo.md) — rota **local** por padrão, **obsidian** só a pedido, bloco colável como último recurso |
