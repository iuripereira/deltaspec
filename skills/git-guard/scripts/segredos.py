...
# Bundle gerado por ferramenta (página autocontida do archify em docs/diagrams/): o runtime
# JavaScript embutido tem variáveis `token`/`tokenKind` seguidas de valor minificado, e o
# padrão genérico casa o NOME da chave — falso positivo medido 3× por página (DT-162).
