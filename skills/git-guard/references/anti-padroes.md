...
Coluna **estado**: `check` = auditado hoje pelo `audit_workspace.py` · `trava` = travado hoje · `catalogado` = descrito e ranqueado, sem mecanismo ainda.

### G1 — segredo versionado
**Dano:** máximo · **Frequência:** baixa por evento, catastrófica por consequência · **Camada:** local + servidor · **Estado:** check
...
**Dano:** alto · **Frequência:** altíssima (é o estado inicial de todo repositório) · **Camada:** agente · **Estado:** check
...
### G5 — commit gigante
**Dano:** médio (review superficial, `revert` impraticável, `bisect` inútil) · **Frequência:** altíssima · **Camada:** local + servidor · **Estado:** check
...
**Dano:** médio · **Frequência:** máxima · **Camada:** local + servidor · **Estado:** check
...
**Dano:** alto e diferido · **Frequência:** média · **Camada:** local + servidor · **Estado:** check
...
**Dano:** baixo (diff poluído por normalização de fim de linha; review sem dono definido) · **Frequência:** altíssima · **Camada:** local + servidor · **Estado:** catalogado
...
**Dano:** baixo · **Frequência:** alta · **Camada:** nenhuma · **Estado:** catalogado
...
**Dano:** baixo, mas é sintoma · **Frequência:** alta · **Camada:** nenhuma · **Estado:** catalogado
...
**Dano:** multiplicador · **Frequência:** máxima sob pressão · **Camada:** agente · **Estado:** catalogado
...
**Dano:** máximo · **Frequência:** alta (push recusado → o modelo "resolve" com força) · **Camada:** servidor + agente · **Estado:** catalogado
...
**Dano:** máximo e irrecuperável · **Frequência:** alta · **Camada:** agente · **Estado:** catalogado
...
**Dano:** máximo · **Frequência:** média · **Camada:** agente · **Estado:** catalogado
...
### G16 — `git add -A` ⚠
**Dano:** médio a alto (varia com o que estava fora do `.gitignore`) · **Frequência:** máxima · **Camada:** agente · **Estado:** catalogado
