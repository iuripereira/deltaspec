...
A décima sétima não é comando: [`eu-tenho-tdah`](skills/eu-tenho-tdah/SKILL.md) é o perfil de escrita do Iuri (baseado em [ayghri/i-have-adhd](https://github.com/ayghri/i-have-adhd)), ligado o tempo todo — ação antes de contexto, listas ranqueadas, tangente vira pendência salva.
