...
[Versão corrente: tags](https://github.com/iuripereira/deltaspec/tags) · 14 skills · Licença MIT
...
Pronto: as 14 skills aparecem com o prefixo `deltaspec:`. Para atualizar depois, `/plugin update deltaspec@deltaspec` — sem o `@deltaspec` do marketplace, o plugin não é encontrado.
...
Doze comandos do ciclo, na ordem em que você os encontra. Clique no nome para ler o detalhe da skill.
...
A décima quarta não é comando: [`eu-tenho-tdah`](skills/eu-tenho-tdah/SKILL.md) é o perfil de escrita do Iuri (baseado em [ayghri/i-have-adhd](https://github.com/ayghri/i-have-adhd)), ligado o tempo todo — ação antes de contexto, listas ranqueadas, tangente vira pendência salva.
