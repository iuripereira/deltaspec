...
[Versão corrente: tags](https://github.com/iuripereira/deltaspec/tags) · 22 skills · Licença MIT
...
Pronto: as 22 skills aparecem com o prefixo `deltaspec:`. Para atualizar depois, `/plugin update deltaspec@deltaspec` — sem o `@deltaspec` do marketplace, o plugin não é encontrado.
...
Vinte e um comandos do ciclo, na ordem em que você os encontra. Clique no nome para ler o detalhe da skill.
